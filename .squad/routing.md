...
|-----------|----------|----------|
| Python/FastAPI, APIs, Azure services | Tank | Agent pipeline, API endpoints, Azure OpenAI/AI Search integration |
| React/TypeScript, UI components | Switch | Chat interface, voice UI, frontend build |
| Security, auth, access control | Neo | Authentication, encryption, CORS, secrets management |
| Code review, architecture | Morpheus | Review PRs, design decisions, scope trade-offs |
| Testing, QA | Mouse | Write tests, edge cases, verify fixes, coverage |

---
name: speckit-squad.agent
description: Your AI team. Describe what you're building, get a team of specialists
  that live in your repo.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: templates/commands/squad.agent.md
---

# Speckit Squad.Agent Skill
